...
Good security professionals also exhibit perseverance, determination, and the ability to overcome frustration since most work requires a lot of experimenting to be successful.  Most of the time this includes researching other professionals' work and recreating it in a lab setting.  Sometimes this work may skip steps or have inaccuracies that are needed to get an attack or countermeasure to work.  Breaking problems down, troubleshooting, and never giving up is required to overcome these shortfalls. 
